...
exports.smsg = (conn, m, hasParent) => {
    ...
    /*m.reply = async (text, chatId, options) => {
        ...
        conn.reply(chatId ? chatId : m.chat, text, m, { contextInfo: { mentionedJid: conn.parseMention(text), externalAdReply: { title: 'ꜱɪᴍᴩʟᴇ ᴡʜᴀᴛꜱᴀᴩᴩ ʙᴏᴛ', body: 'mrsanon', sourceUrl: 'https://wa.me/94766816809', thumbnail: data }}, options })
    }
    /**
     * Copy this message
     */
